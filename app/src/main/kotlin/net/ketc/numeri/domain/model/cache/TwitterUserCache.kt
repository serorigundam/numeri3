...
fun User.convertAndCache() = TwitterUserCache.putOrGet(this)

fun TwitterClient.user(): TwitterUser = TwitterUserCache.get(id) ?: this@user.twitter.showUser(this@user.id).convertAndCache()
