...
class StreamHandler(private val repository: ITwitterStreamRepository) : IStreamHandler {
    override fun getStream(client: TwitterClient): TwitterStream = client.getStream(repository)
}
